...
- `apply-r8m2v6q4/index.html`: 가산 Claude 4회차 교육생 모집 홍보 페이지
...
현재 CSS와 스크립트 캐시 버전은 `20260901-10`입니다. 디자인이나 기능 파일을 수정한 뒤에는 세 과정의 `index.html`에 있는 `?v=20260901-10` 값을 새 번호로 함께 변경하세요.

## 과정별 공유 주소

- 가산 A반: `https://계정명.github.io/gasan-a/`
- 가산 Claude 4회차: `https://계정명.github.io/class-k7m4q9x2/`
- 가산 Claude 4회차 모집 안내: `https://계정명.github.io/apply-r8m2v6q4/`
